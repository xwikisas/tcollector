...
def collect(db):
  ...
  mysql_slowest_query = db.query("select time,db from information_schema.processlist where command!='Sleep' and command!='Connect' and command!='Binlog Dump' and time>='300' order by time DESC limit 1;")
